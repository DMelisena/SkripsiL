...
def simulate_dose(distance_from_source, particle, particles_per_shot, energy):
    ...
    phantom_univ=openmc.Universe(cells=[phantom_cell])
    void_univ=openmc.Universe(cells=[void_cell])
    phantom_univ.plot(width=(50, 50))
    phantom_univ.plot(width=(50, 50),basis='xz')
    void_univ.plot(width=(50, 50))
    void_univ.plot(width=(50, 50),basis='xz')
    plt.show()
