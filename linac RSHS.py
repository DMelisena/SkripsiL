...
F1 = 120
#209 - 93 = 89
I = 226 #420-I=190 ; I = 230  ; Dingin tebal kiri linac
I1 = 147 # 420-I1=270 ; I=150 ; dinding kiri
#226 - 147 = 79
E = 85 #(x/2)-E; 420-85=335
G = 74 #365-G=72 g=293
H = 90 #368-H=280
# Dimensi Dinding, Gap, Lorong, dll
L1 = 120 #335-217=118 Lorong 1
L2 = 195 
Q1 = 90  #280-190 = 90 ;
Q2 = 300 #-189--100 = panjang kotak sekitar linac 290.. kira2 300 alias bener
# Kolimator (ditengah pasien??)
xk = 34.0 #(-75 = -94+ xk ; xk roughly 19)
yk = 35.0 
zk1 = 7
zk2 = 21
zg = 10
...
#kotak 2 dimensi berukuran hole2 x hole2
...
# Kolimator x-94 ; y-44.5 ; z-75
#xk = 34.0 #(-75 = -94+ (xk/2) ; xk roughly 19)
#yk = 35.0 #(-62.5 = 
#zk1 = 7
#zk2 = 21
#zg = 10 
     # zk1+xk2+zg=38, benerkah kalo ini 
#zkol = 100 - zk1 - zk2 - zg # 62 Jarak Kolimator Sekunder ke Pasien #62
#hole1 = 4/2
#hole1h = 6.1
#hole2 = 3.7 #1.85
...
#gambar 5.1
#Detector I ;sejarak xdet dari tembok kiri luar. kotak bolong x : yz simetris pasien
...
#Detector G ;kotak bolong y; x simetris dengan pasien
...
#Detector H ;papan sumbu y di dinding belakang
